...
--
-- Host: 127.0.0.1
-- Generation Time: May 17, 2024 at 03:27 PM
...
ALTER TABLE `booked`
  ...
  ADD KEY `fk_booking_no` (`booking_no`);
...
--
ALTER TABLE `booking`
  MODIFY `booking_no` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `booked`
  ADD CONSTRAINT `booked_ibfk_1` FOREIGN KEY (`booking_no`) REFERENCES `booking` (`booking_no`),
  ADD CONSTRAINT `fk_booking_no` FOREIGN KEY (`booking_no`) REFERENCES `booking` (`booking_no`) ON DELETE CASCADE;
